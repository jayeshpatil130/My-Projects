...
CREATE TABLE `patient_insurance` (
  ...
  KEY `fk_Patient_Insurance_Patients1_idx` (`Patients_idPatients`),
  CONSTRAINT `fk_Patient_Insurance_Patients1` FOREIGN KEY (`Patients_idPatients`) REFERENCES `patients` (`idpatients`)
...
INSERT INTO `patient_insurance` VALUES (1201,'Bluecross','2018-12-18',1),(1202,'Bluecross','2018-12-12',2),(1203,'ISO','2018-12-11',3),(1204,'HelathS','2018-12-19',4),(1205,'Health Gold','2018-12-10',5),(1206,'ISO silver','2018-12-14',6);
